...
/* ============================================================
   NAVIGASI ANTAR HALAMAN (dengan animasi transisi)
   ============================================================ */
...
function goToNextPage() {
  ...
  setTimeout(() => {
    current.classList.remove('page-active', 'page-leave');
    pageLoader.classList.add('show');

    setTimeout(() => {
      pageLoader.classList.remove('show');
      next.classList.add('page-active');
      // paksa reflow supaya animasi enter selalu ke-trigger ulang
